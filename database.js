...
let DEFAULT_COMPTES = [
    { id: 'compte_3', numeroCompte: '3', pseudo: 'marie_sdm963', telephone: '', email: '', motDePasse: '', gereParInitiales: '', agent: 'Ricardo', statut: 'Actif', dateStatutCompte: '', notes: 'Ancien compte Num 3', organisationId: 'org_default' },
    { id: 'compte_14', numeroCompte: '14', pseudo: 'lola_ver', telephone: '', email: '', motDePasse: '', gereParInitiales: '', agent: 'Ricardo', statut: 'Actif', dateStatutCompte: '', notes: 'Ancien compte Num 14', organisationId: 'org_default' },
    { id: 'compte_16', numeroCompte: '16', pseudo: 'lisa_llc', telephone: '', email: '', motDePasse: '', gereParInitiales: '', agent: 'Juliana', statut: 'Actif', dateStatutCompte: '', notes: 'Ancien compte Num 16', organisationId: 'org_default' },
    { id: 'compte_18', numeroCompte: '18', pseudo: 'elsa_vay', telephone: '', email: '', motDePasse: '', gereParInitiales: '', agent: 'Muller', statut: 'Actif', dateStatutCompte: '', notes: 'Ancien compte Num 18', organisationId: 'org_default' },
    { id: 'compte_20', numeroCompte: '20', pseudo: 'julia_rent', telephone: '', email: '', motDePasse: '', gereParInitiales: '', agent: 'Ricardo', statut: 'Actif', dateStatutCompte: '', notes: 'Ancien compte Num 20', organisationId: 'org_default' },
    { id: 'compte_29', numeroCompte: '29', pseudo: 'isis_mlf_old', telephone: '', email: '', motDePasse: '', gereParInitiales: '', agent: 'Muller', statut: 'Actif', dateStatutCompte: '', notes: 'Ancien compte Num 29', organisationId: 'org_default' },
    { id: 'compte_47', numeroCompte: '47', pseudo: 'elina_sor', telephone: '07 33 00 00 00', email: 'mmanjudj2@gmail.com', motDePasse: 'ymdrc4EWE0t6ws1', gereParInitiales: '', agent: 'Muller', statut: 'Actif', dateStatutCompte: '28/07/2026', notes: '', organisationId: 'org_default' },
    ...
    { id: 'compte_50', numeroCompte: '50', pseudo: 'elya_soc', telephone: '06 33 43 94 35', email: 'ciel2azur123@gmail.com', motDePasse: 'ciel2azur*', gereParInitiales: 'EG', agent: 'Florencio', statut: 'Actif', dateStatutCompte: '31/07/2026', notes: 'Num 30', organisationId: 'org_default' },
    { id: 'compte_51', numeroCompte: '51', pseudo: 'lina_mya8', telephone: '06 33 43 89 34', email: 'ee010020@outlook.fr', motDePasse: 'Vinted009&*', gereParInitiales: 'EG', agent: 'Lova', statut: 'Banni', dateStatutCompte: '01/08/2026', notes: 'Vinted bloqué dès l’ouverture 01/08/2026', organisationId: 'org_default' },
